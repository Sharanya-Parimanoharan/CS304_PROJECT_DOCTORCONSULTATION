...
export default function ViewFeddBacks() {
...
//   }
  ...
  useEffect(()=>{
    axios.get('http://localhost:8081/feedbacks').then((response)=>{
          ...
          <Scrollbar>
            <TableContainer sx={{ minWidth: 800 }}>
              <Table>
                  ...
                  <TableCell style={{backgroundColor:"lightblue"}}>stars</TableCell>
                  <TableCell style={{backgroundColor:"lightblue"}}>Message</TableCell>
                  <TableCell style={{backgroundColor:"lightblue"}}>{}</TableCell>
                </TableHead>
                <TableBody>
                {feedbacks.filter((val)=>{
                        if(search===""){
                           return val
                         }
                        ...
                        return null
                         ...
                         //   val.patient.map((feedb,index)=>{
                           //     return(
                            ...
                            <TableCell align='left'>{val.stars}</TableCell>
