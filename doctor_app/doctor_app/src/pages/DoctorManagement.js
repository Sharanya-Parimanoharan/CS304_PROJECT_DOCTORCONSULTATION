...
export default function UserPage() {
  ...
  useEffect(()=>{
    ...
    if(location?.state?.data==null){
      ...
      navigate("/login/admindashboard/doctormanagement")
    });}
    else{
      setDoctorData(location?.state?.data);
    }
  },[]);
...
const handleCancelClick=()=>{
  ...
  return (
   ...
   <br />
      ...
      <TableRow>
        <>
        { editId===val.doctorId ?<EditableRow editFormData={editFormData} 
        handleEditFormChane={handleEditFormChane} handleCancelClick={handleCancelClick} handleEditSubmit={handleEditSubmit}/> :  
        <ReadOnlyRow val={val} handleEditClick={handleEditClick} deleteDoc={deleteDoc}/>}
